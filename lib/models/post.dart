...
//
//     final wpPost = wpPostFromJson(jsonString);
...
class WpPost {
  ...
  factory WpPost.fromJson(Map<String, dynamic> json) => WpPost(
    ...
    aioseoNotices: List<dynamic>.from(json["aioseo_notices"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "aioseo_notices": List<dynamic>.from(aioseoNotices!.map((x) => x)),
    "_links": links!.toJson(),
  };
}
